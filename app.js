...
const { createNewSheet, saveResponseToSheet, checkIfAnswered } = require('./sheets');
...
        await saveResponseToSheet({ sheetName, user: userName, question: questionText, answer: combinedAnswer, timestamp: new Date().toISOString() });
...
    }
    
    await saveResponseToSheet({ sheetName, user: userName, question, answer: combinedAnswer, timestamp: new Date().toISOString() });
    
